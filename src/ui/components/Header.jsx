export const Header = () => {
  return (
    <header className='sticky top-0 h-16 z-30 w-full'>
      <nav className='flex bg-white/30 px-4 lg:px-6 py-2.5 dark:bg-gray-800 w-full backdrop-blur-sm ring-1 ring-black/5 shadow-md shadow-slate-500/60'>
        ...
        <div
          className='hidden justify-between items-center px-6 w-full flex-1 lg:flex lg:w-auto lg:order-1'
          id='mobile-menu-2'
        >
