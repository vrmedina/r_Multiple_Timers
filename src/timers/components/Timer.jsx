export const Timer = () => {
  return (
    <>
      <div className='relative flex w-full max-w-[14rem] flex-col rounded-xl bg-gradient-to-tr from-gray-900 to-gray-500 bg-clip-border p-2 text-slate-100 shadow-md shadow-slate-500/80 m-1'>
        <div className='flex-col relative m-0 my-2 overflow-hidden rounded-no bg-transparent bg-clip-border text-center text-gray-700 shadow-none'>
          <div className="flex align-middle text-center justify-between">
            <p className='flex self-start font-sans text-sm font-normal uppercase leading-normal text-white antialiased py-2.5 ms-3'>
              Mi Temporizador
            </p>
          ...
          <h1 className='flex-3 my-3 block justify-center gap-0 font-sans text-4xl tracking-normal text-white antialiased'>
            15 : 24 : 36
          </h1>
        </div>
